...
public class JiraSoapServiceProxy implements jira.rpc.soap.jirasoapservice_v2.JiraSoapService {
  private String _endpoint = null;
  private jira.rpc.soap.jirasoapservice_v2.JiraSoapService jiraSoapService = null;
  ...
  private void _initJiraSoapServiceProxy() {
    try {
      jiraSoapService = (new jira.rpc.soap.jirasoapservice_v2.JiraSoapServiceServiceLocator()).getJirasoapserviceV2();
  ...
  public jira.rpc.soap.jirasoapservice_v2.JiraSoapService getJiraSoapService() {
    if (jiraSoapService == null)
      _initJiraSoapServiceProxy();
